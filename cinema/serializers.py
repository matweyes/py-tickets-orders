...
class MovieSessionSerializer(serializers.ModelSerializer):
    ...
    tickets_available = serializers.IntegerField(source="available_tickets",
                                                 read_only=True)

    class Meta:
        model = MovieSession
        fields = ("id", "show_time", "movie_title", "cinema_hall_name",
                  "cinema_hall_capacity", "tickets_available", "cinema_hall",
                  "movie")
...
class CreateOrderSerializer(serializers.ModelSerializer):
    tickets = CreateTicketSerializer(many=True)
